...
julia --project=$proj --startup-file=no -t auto $proj/main.jl $SGE_TASK_ID $XI $D

# Preferably, tar-up (archive) all output files onto the shared scratch area
outpath=${proj}/data/raw/xi=${XI}_D=${D}
mkdir -p $outpath
